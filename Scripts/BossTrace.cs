...
public class BossTrace : MonoBehaviour {
	...
	private BossHealth bossHealth;		//敌人的生命值脚本
	...
	void Start () {
		...
		bossHealth = GetComponent<BossHealth> (); //获取敌人的生命值脚本
		target = GameObject.FindGameObjectWithTag("Player");
	}

	//每帧执行一次，用于敌人追踪目标
	void Update () {
		if (bossHealth!=null && bossHealth.health <= 0) return;	//当敌人死亡时，敌人无法追踪目标
